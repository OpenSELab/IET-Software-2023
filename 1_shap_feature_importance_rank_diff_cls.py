# -*- coding: utf-8 -*-
"""1-SHAP_feature_importance_rank_diff_cls

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xks0LNFbDolBvTWRVZkaD3hq4EU5rS6P
"""
...
"""
print(DT_diff_count_L_O_diff_1_pd)
print(DT_diff_count_L_O_diff_1_pd.loc[DT_diff_count_L_O_diff_1_pd["label"]==1.0].empty)
if(DT_diff_count_L_O_diff_1_pd.loc[DT_diff_count_L_O_diff_1_pd["label"]==2.0].empty):
  print(111)
else:
  print(222)
"""
...
def newdatatable(pd_old,classname):
  ...
  if(pd_old['probability'].loc[pd_old["label"]==0.0].empty):
    prob_0 = 0
  else:
    prob_0 = float(pd_old['probability'].loc[pd_old["label"]==0.0])

  if(pd_old['probability'].loc[pd_old["label"]==1.0].empty):
    prob_1 = 0
  else:
    prob_1 = float(pd_old['probability'].loc[pd_old["label"]==1.0])

  if(pd_old['probability'].loc[pd_old["label"]==2.0].empty):
    prob_2 = 0
  else:
