# -*- coding: utf-8 -*-
"""1-permutation_different_metric_overlap_all_compute_plot_Recall

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Hq45kkIoYYZXv3_I9v_77gv9uzuhYW2H
"""
...
# 置换特征重要性在测试集上不同的指标得到的特征排名的一致性 Overlap 这个文件是计算 recall
...
data_o_Promise = pd.DataFrame(pd.read_csv(rootpath + datasets_original + "Promise-permutation-test-recall-rank.csv"))

data_o_ReLink = pd.DataFrame(pd.read_csv(rootpath + datasets_original + "ReLink-permutation-test-recall-rank.csv"))

data_o_AEEEM = pd.DataFrame(pd.read_csv(rootpath + datasets_original + "AEEEM-permutation-test-recall-rank.csv"))

data_log_Promise = pd.DataFrame(pd.read_csv(rootpath + datasets_log + "Promise-permutation-test-recall-rank.csv"))

data_log_ReLink = pd.DataFrame(pd.read_csv(rootpath + datasets_log + "ReLink-permutation-test-recall-rank.csv"))

data_log_AEEEM = pd.DataFrame(pd.read_csv(rootpath + datasets_log + "AEEEM-permutation-test-recall-rank.csv"))


data_min_Promise = pd.DataFrame(pd.read_csv(rootpath + datasets_minmax + "Promise-permutation-test-recall-rank.csv"))

data_min_ReLink = pd.DataFrame(pd.read_csv(rootpath + datasets_minmax + "ReLink-permutation-test-recall-rank.csv"))

data_min_AEEEM = pd.DataFrame(pd.read_csv(rootpath + datasets_minmax + "AEEEM-permutation-test-recall-rank.csv"))

data_sta_Promise = pd.DataFrame(pd.read_csv(rootpath + datasets_standardize + "Promise-permutation-test-recall-rank.csv"))

data_sta_ReLink = pd.DataFrame(pd.read_csv(rootpath + datasets_standardize + "ReLink-permutation-test-recall-rank.csv"))

data_sta_AEEEM = pd.DataFrame(pd.read_csv(rootpath + datasets_standardize + "AEEEM-permutation-test-recall-rank.csv"))
...
with sns.axes_style('darkgrid'):
  ...
  axes[0][0].set_title( "Recall Top-1 Overlap",loc='center'  )
  ...
  axes[0][1].set_title( "Recall Top-3 Overlap",loc='center'  )
  ...
  axes[0][2].set_title( "Recall Top-5 Overlap",loc='center'  )
