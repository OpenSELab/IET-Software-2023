# -*- coding: utf-8 -*-
"""1-permutation_different_metric_overlap_all_compute_plot_Precision

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ySoWZ1aI3KNHVYNREG1-4WqyxEKVeVvf
"""
...
# 置换特征重要性在测试集上不同的指标得到的特征排名的一致性 Overlap 这个文件是计算 precision
...
with sns.axes_style('darkgrid'):
  ...
  axes[0][0].set_title( "Precision Top-1 Overlap",loc='center'  )
  ...
  axes[0][1].set_title( "Precision Top-3 Overlap",loc='center'  )
  ...
  axes[0][2].set_title( "Precision Top-5 Overlap",loc='center'  )
